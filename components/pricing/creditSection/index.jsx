  ...
  const creditPackages = [
    {
      ...
      credits: 40,
      creditsType: "yellow",
      benefit: dictionary.smallYellow,
      price: "5,99€",
    ...
    },
    {
      ...
      credits: 80,
      creditsType: "yellow",
      benefit: dictionary.mediumYellow,
      price: "9,99€",
    ...
    },
    {
      ...
      credits: 260,
      creditsType: "yellow",
      benefit: dictionary.largeYellow,
      price: "29,99€",
  ...
  return (
    <div className='z-10  w-full h-full flex flex-col md:gap-12 gap-10 md:flex-col text-white justify-center items-center md:mt-16'>
      <span className='text-center w-3/4 block text-white headline-3 z-[10] '>
        {dictionary.our} <span className='text-irisPurpleLight'>{dictionary.creditPackage}</span> {dictionary.atAGlance}{" "}
      </span>
