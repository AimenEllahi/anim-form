      ...
      <div className='flex flex-col w-full gap-10 z-[10]'>
        ...
        <div className='text-white flex flex-col gap-8 justify-center items-center'>
          <div className='flex flex-col gap-5 md:w-[711px] w-full'>
            <span className='running-text-large'>Conditions, August 17, 2024</span>
            <p>
            ...
            <p>
              ...
              Use of the Product is also subject to acceptance of Dndai.app's Privacy Policy available at https://www.dndai.app/privacy.
          ...
          <div className='flex flex-col gap-5 md:w-[711px] w-full'>
            <span className='running-text-large'>1. ELIGIBILITY</span>
            <p>
              In order to use certain Products you may be required to:
              <ul>
                <li>meet minimum age requirements - see Sections 1 and 10</li>
                <li>agree to Third Party Terms - see Section 15</li>
                <li>open an account operated and provided by Dndai.app - see Section 10</li>
              </ul>
          ...
          <div className='flex flex-col gap-5 md:w-[711px] w-full'>
            <span className='running-text-large'>3. LICENSE</span>
            <p>
            ...
            <p>
              ...
              <ul>
                <li>use, develop, host or distribute cheats, automation software (bots), modded lobbies, hacks, mods or any other unauthorized third-party software in connection with the Product, or engage in any form of cheating, boosting, or booting;</li>
                <li>exploit or reverse engineer the Product (or any of its parts), for any commercial purpose, including without limitation (a) to enable use at a cyber cafe, computer gaming center or any other location-based site without the express written consent of Dndai.app; (b) for gathering in-game currency, items or resources for sale outside the Product; (c) performing in-game services in exchange for payment outside the Product, e.g., power-leveling; or (d) the sale of accounts, log-in information, or other Product materials, access, or rights;</li>
                <li>use any unauthorized third-party software that intercepts, "mines", or otherwise collects information from or through the Product;</li>
                <li>except as authorized by Dndai.app in writing, host, provide or develop matchmaking services for the Product, or intercept, emulate or redirect the communication protocols used by Dndai.app in any way, for any purpose, including without limitation unauthorized play over the internet, network play, or as part of content aggregation networks;</li>
                <li>facilitate, create or maintain any unauthorized connection to the Product, including without limitation (a) any connection to any unauthorized server that emulates, or attempts to emulate, the Product; and (b) any connection using programs or tools not expressly approved by Dndai.app in writing;</li>
                <li>violate any applicable law or regulation in connection with your use of Product;</li>
                <li>disrupt or assist in the disruption of: (i) any computer, device or server used to support the Product; or (ii) any other player's use of a Product;</li>
              </ul>
            </p>
          </div>
          <div className='flex flex-col gap-5 md:w-[711px] w-full'>
            <span className='running-text-large'>4. BINDING ARBITRATION AND CLASS ACTION WAIVER</span>
            <p>
            ...
            <p>
              Exception - Litigation of Intellectual Property and Small Claims Court Claims: Notwithstanding the parties' decision to resolve all disputes through arbitration, either party may bring an action in state or federal court that only asserts claims for patent infringement or invalidity, copyright infringement, moral rights violations, trademark infringement, and/or trade secret misappropriation, but not, for clarity, claims related to the license granted to you for the Product under this Agreement. Such claims aresubject to the jurisdiction and applicable law provisions in Section 5.
            </p>
            <p>
          ...
          <div className='flex flex-col gap-5 md:w-[711px] w-full'>
            <span className='running-text-large'>5. JURISDICTION, AND APPLICABLE LAW AND CONTRACTING PARTIES</span>
            <p>
          ...
          <div className='flex flex-col gap-5 md:w-[711px] w-full'>
            <span className='running-text-large'>6. SERVICES</span>
            <p>
              Separate from any license to use the intellectual property of Dndai.app or its licensors set out in Section 3 above, some Products also contain game features or content that are only accessible through online hosting and/or other online services and functionality provided by Dndai.app ("Services"). As detailed in Section 2, you will provide Internet access necessary to use these services at your own cost and expenses. All such Services are provided to you by Dndai.app on a personal, non-commercial and non-transferable basis. All such Services are provided subject to the terms of this Agreement and Dndai.app's Privacy Policy, and such additional terms, if any, as may be applicable to such Services.
            </p>
          </div>
          <div className='flex flex-col gap-5 md:w-[711px] w-full'>
            <span className='running-text-large'>7. USE OF DATA</span>
            <p>
              FOR FULL DETAILS ABOUT HOW DNDAI.APP COLLECTS, STORES AND USES PERSONAL AND OTHER INFORMATION, PLEASE SEE THE PRIVACY POLICY AVAILABLE AT https://www.dndai.app/privacy
          ...
          <div className='flex flex-col gap-5 md:w-[711px] w-full'>
            <span className='running-text-large'>8. USER GENERATED CONTENT</span>
            <p>
            ...
            <p>
              Dndai.app has no obligation to monitor, approve, verify, or prescreen any UGC that you and other users may contribute to or through the Product. Dndai.app reserves the right (but has no obligation) to remove, block, edit, move or disable UGC for any reason in Dndai.app's sole discretion. To the maximum extent permitted by applicable law, Dndai.app does not assume any responsibility or liability for your UGC or that of other users, or for any failure to monitor, edit, or remove UGC. You agree that you shall not hold Dndai.app liable for any loss or damage arising from the contents of any UGC (yours or another user's) including without limitation in respect of any defamation, harassment, or false endorsement claims.
            </p>
            <p>
              ...
              <ul>
                <li>Harass, threaten, embarrass or cause distress or discomfort upon another participant, user, or other individual or entity;</li>
                <li>Transmit any UGC that Dndai.app considers to be disruptive, unlawful, harmful, threatening, abusive, harassing, defamatory, vulgar, obscene, hateful, or racially, sexually, ethnically or otherwise objectionable;</li>
                <li>Impersonate any person or entity, including but not limited to Dndai.app;</li>
                <li>Disrupt normal Product functionality, or otherwise act in a manner that negatively affects other participants and/or the overall Product experience;</li>
                <li>Post or transmit any unsolicited advertising, promotional materials, or any other forms of solicitation;</li>
                <li>Intentionally or unintentionally violate any applicable law, regulation or treaty while using or accessing the Product;</li>
                <li>Post multiple posts of the same content (e.g., "spam"); or</li>
                <li>Invade the privacy or violate or infringe any right of any person or entity, including, without limitation, any intellectual property right.</li>
              </ul>
          ...
          <div className='flex flex-col gap-5 md:w-[711px] w-full'>
            <span className='running-text-large'>9. DNDAI.APP ACCOUNTS</span>
            <p>
            ...
            <p>
              ...
              If you are a registered user of social media sites you may be able to connect your social media account and your Dndai.app account (if your applicable Dndai.app account has this functionality enabled). Your social media accounts are subject to their own Third Party Terms. You acknowledge and agree that your social media account provider is not responsible for your Dndai.app account, including for any liability connected to your use of your Dndai.app account, and that irrespective of whether you use an anonymous gamer tag or username, once you connect your Dndai.app account to your social media account, your real name will be available and viewable by your social media "friends". Please also see Dndai.app's Privacy Policy available at https://www.dndai.app/privacy for additional information on social networks.
              Depending on which Product and platform or Device you are using, your username on the platform may be your username in the Dndai.app account. Additionally, some Dndai.app accounts may allow users to form different "clans", "squads", "teams", or other groups (collectively "groups") with unique group names. When you choose a username or a group name, or otherwise create a label that can be seen by other users, you must abide by the following guidelines as well as the rules of common decency. If Dndai.app finds such a nameto be offensive or improper, it may, in its sole and absolute discretion, change or remove the name, and/or suspend or terminate your use of the service and, if you are a resident outside North America, apply additional consequences set out in Section 14(B)(ii). In particular, you may not use any name:
              <ul>
                <li>Belonging to another person with the intent to impersonate that person, including without limitation any Product administrators or any other employee or agent of Dndai.app;</li>
                <li>That incorporates vulgar language or which is otherwise offensive, defamatory, obscene, hateful, or racially, sexually, ethnically or otherwise objectionable;</li>
                <li>Belonging to any religious figure or deity;</li>
                <li>Related to drugs, sex, alcohol, or criminal activity;</li>
                <li>That is subject to the rights of any other person or entity without written authorization from that person or entity;</li>
                <li>That belongs or refers to a popular culture figure, celebrity, media personality, icon or persona;</li>
                <li>That is, contains, or is substantially similar to a trademark or service mark, whether registered or not.</li>
              </ul>
