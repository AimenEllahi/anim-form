...
export default function Index() {
    ...
    return isEditing.personalData ? (
      ...
      <div>
        <div className="p-4 flex flex-col">
          <span className="font-roboto-mono text-irisPurpleLight">
            USERNAME
          </span>
          <span className="running-text-mono">ANTICHRISTUS</span>
        </div>
        <div className="p-4 flex flex-col">
          <span className="font-roboto-mono text-irisPurpleLight">NAME</span>
          <span className="running-text-mono">LUCAS</span>
        </div>
        <div className="p-4 flex flex-col">
          <span className="font-roboto-mono text-irisPurpleLight">SURNAME</span>
    ...
    return isEditing.email ? (
      <div>
        <div className="p-4 flex flex-col gap-8">
          <CustomInput
            placeholder="E-MAIL"
            defaultValue="rossmann.lucas@gmx.at"
          />
        </div>
        <hr className="border border-white/[8%]" />
        <div className="flex gap-4 justify-end items-end p-4">
      ...
      <div>
        <div className="p-4 flex flex-col uppercase">
          <span className="font-roboto-mono text-irisPurpleLight">E-MAIL</span>
          <span className="running-text-mono">rossmann.lucas@gmx.at</span>
        </div>
      </div>
    );
  };
  ...
  return (
    <div className="w-4/5 border px-28 flex flex-col gap-4">
