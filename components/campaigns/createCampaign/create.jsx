...
export default function create({ campaign, handleSetCampaign }) {
  return (
    <div className='w-full h-full flex flex-col md:gap-5 gap-10 md:flex-row pt-4 md:pt-8 '>
      ...
      <div className='  h-full !max-h-[652px]  overflow-y-scroll hide-scrollbar text-white md:w-2/5 w-full md:border border-white/10 md:rounded-[16px] md:bg-white/[8%]  md:p-5 md:pt-3.5 flex flex-col gap-5 '>
        <h1 className='running-text-large '>Campaign Details</h1>
        <CampaignDetails
          campaign={campaign}
