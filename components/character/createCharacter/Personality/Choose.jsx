...
export default function Choose({ handleSetPersonality, personalities }) {
  ...
  return (
    <div className='md:rounded-[16px]  w-full md:w-full lg:w-4/5 flex flex-col gap-6  h-fit max-h-full  md:p-5 md:pt-3.5  md:border border-white/10 md:bg-white/[8%]  overflow-y-scroll hide-scrollbar'>
      <h1 className='running-text-large  hidden md:block'>Personality</h1>
