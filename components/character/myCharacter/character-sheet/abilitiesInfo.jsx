...
export default function abilitiesInfo({ character }) {
  ...
  return (
    <div className="flex flex-col gap-5 z-[1]">
      <div className=" h-auto w-[345px] p-5 pt-6  flex flex-col gap-4 justify-start bg-white/10 rounded-[16px] border border-white/10">
        <span className="headline-4">Appearance</span>
        <span className="running-text text-gray2">
          Sarah is a striking Drow with obsidian skin and stark white hair. Her
          piercing silver eyes seem to glow in the darkness. She carries herself
          with confidence and grace, always ready for the next adventure.
        </span>
      </div>
      <div className=" h-auto w-[345px] p-5 pt-6  flex flex-col gap-4 justify-start bg-white/10 rounded-[16px] border border-white/10">
