...
export default function CustomIconButton({
  ...
  return (
    <div
      ...
      className={cn(
        "bg-white/10 h-9 w-9 rounded-full border bg-blur flex items-center justify-center box-border ease-animate  border-white/[8%] hover:border-white/20 hover:bg-white/10 md:active:bg-white/20 md:active:border-white/40 disabled:opacity-30 disabled:pointer-events-none hover:!duration-200 active:!duration-100 focus:outline-none ",
        variant === "primary" &&
          "bg-white hover:bg-gray1 md:active:bg-gray2 border-0 text-russianViolet",
